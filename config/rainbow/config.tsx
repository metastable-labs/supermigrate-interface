...
import VelodromeRouter from './abis/VelodromeRouter.json';
import VelodromeFactory from './abis/VelodromeFactory.json';
...
export const networks: NetworkProps[] = [
  {
    ...
    velodromeRouterAddress: '0xcF77a3Ba9A5CA399B7c97c74d54e5b1Beb874E43', // aerodrome
    velodromeFactoryAddress: '0x420DD381b31aEf6683db6B902084cB0FFECe40Da', // aerodrome
    velodromeRouterAbi: AerodromeRouter,
    velodromeFactoryAbi: AerodromeFactory,
  ...
  },
  {
    ...
    velodromeRouterAbi: VelodromeRouter,
    velodromeFactoryAbi: VelodromeFactory,
    abi: OptimismMintableERC20Factory.abi,
