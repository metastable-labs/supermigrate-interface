...
const SectionThree = () => {
  ...
  return (
    <section className="bg-[#EFFAF6] py-6 lg:py-[50px] px-4 lg:px-[50px] rounded-xl mb-8 lg:mb-16">
      ...
      <h4 className="leading-relaxed w-full lg:w-[550px] text-[#717184] text-sm lg:text-[18px]">We are making it seamless for users to transfer assets between L1 and L2 networks.</h4>
