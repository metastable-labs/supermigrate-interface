...
const SectionTwo = () => {
  ...
  return (
    <section id="whitepaper">
      <h1 className="text-center text-[24px] lg:text-[46px] font-medium mt-[24px] lg:mt-[50px]">Everything, all in one place</h1>
      ...
      <section className="my-8 lg:my-16 bg-[#FEF3EB] py-6 lg:py-[50px] rounded-xl px-4 lg:px-[50px]">
        ...
        <div className="lg:w-[600px] w-full">
          <h1 className="py-4 font-medium text-[20px] lg:text-[46px] text-[#6E330C] tracking-tight leading-tight">Deploy canonical bridged tokens</h1>
