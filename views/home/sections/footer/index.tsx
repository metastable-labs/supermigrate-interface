...
const Extra = ({
  ...
  title: string;
  links: { titile: string; url: string }[];
}) => {
  return (
          ...
          <div className="flex flex-col-reverse md:flex-col gap-16 w-full">
            <div className="w-full pb-16 md:px-8 px-2 flex flex-col gap-8 md:flex-row md:justify-between border-b border-primary-1350">
              <div className="flex flex-col gap-2 w-full md:w-auto">
                <h1 className="text-primary-300 font-medium text-[20px] leading-[30px]">
                  Stay up to date
                </h1>
                <h2 className="text-primary-1500 text-[14px] md:text-[16px] leading-[24px]">
            ...
            <div className="w-full md:px-8 px-2 flex flex-col gap-8 md:flex-row md:justify-between">
              <div className="flex flex-col md:gap-8">
                <div className="flex items-center justify-start gap-3">
                  ...
                  <h1 className="font-medium text-sm text-primary-50 tracking-[-0.14px]">
                    Supermigrate
                  </h1>
                </div>

                <p className="hidden md:block text-primary-1500">
