...
const iconPrimaryColors: { [key: number]: string } = {
  0: "#C2540A",
  1: "#1142EF",
  2: "#FF0000",
  3: "#DFFE00",
...
const iconSecondaryColors: { [key: number]: string } = {
  0: "#FCE9DC",
  1: "#dce0f1",
  2: "#f2d9d9",
  3: "#eff2d7",
  ...
  return (
    ...
    >
      <path
        ...
        stroke="url(#paint0_linear_1786_9250)"
        stroke-width="1.28056"
      />
      <defs>
        <linearGradient
          id="paint0_linear_1786_9250"
          x1="835.935"
          y1="140.616"
          x2="835.935"
          y2="-126.437"
        ...
        >
          <motion.stop
            stopColor={iconPrimaryColors[step]}
            initial={{ stopColor: iconPrimaryColors[0] }}
            animate={{ stopColor: iconPrimaryColors[step] }}
          ...
          <motion.stop
            offset="0.50309"
            stopColor={iconSecondaryColors[step]}
            initial={{ stopColor: iconSecondaryColors[0] }}
            animate={{ stopColor: iconSecondaryColors[step] }}
            transition={{ duration: 1 }}
          />
        </linearGradient>
      </defs>
