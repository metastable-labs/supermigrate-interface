...
const Menu = ({ menuOpen, links, actionItems, handleModal }: { menuOpen: boolean; links: INavLinks; actionItems: INavActions; handleModal: (type: 'account' | 'wallet' | 'network') => void }) => {
  return (
    <AnimatePresence>
      {menuOpen && (
        <motion.div
